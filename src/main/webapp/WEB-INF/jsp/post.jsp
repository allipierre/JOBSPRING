		...
		<form method="POST" action="create-job">
			<div class="row">
				<div class="six columns">
					<label for="compnaneInput">Job title</label> <input
						class="u-full-width" type="text"
						placeholder="Job Title (e.g. Accountant)" id="titleInput"
						name="title" value="${job.title}">
				</div>
				<div class="six columns">
					<label for="countryInput">Salary</label> <select
						class="u-full-width" id="countryInput">
						<option value="" disabled="disabled" selected="selected">Please
							select monthly salary</option>
			...
			<textarea class="u-full-width" placeholder="Job Description"
				id="descriptioninput" name="description" value="${job.description}"></textarea>

			<label for="positioninput">Position Requirements</label>
			<textarea class="u-full-width" placeholder="Position Requirements"
				id="positioninput" name="position" value="${job.position}"></textarea>
			<div class="row">
				<div class="six columns">
					<label for="categoryInput">Job category</label> <select
						class="u-full-width" id="categoryinput">
						<option value="" disabled="disabled" selected="selected">Please
							specify job category for this vacancy</option>
						<c:forEach var="industry" items="${industry}">
							<c:choose>
								<c:when test="${industry.id == job.company.id}">
									<option value="${job.company.id}">${industry.industryName}</option>
								</c:when>
			...
			<div class="row">
				<div class="one columns">
					<input class="u-full-width" type="text"
						placeholder="company Industry" id="companyIndustry"
						name="industryId" value="${company.industryId}">
				</div>

				<div class="one columns">
					<input class="u-full-width" type="text"
						placeholder="company Location" id="companyLocation"
						name="location" value="${company.location}">
				</div>

				<div class="one columns">
					<input class="u-full-width" type="text" placeholder="company Size"
						id="companySize" name="numbere" value="${company.numbere}">
				</div>
			</div>

			<input class="cancel button-primary" type="submit" value="CANCEL">
			<input class="button-primary" type="submit" value="SAVE"> <input
