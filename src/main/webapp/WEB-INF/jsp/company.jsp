		...
		<form method="POST" action="company">
			<div class="row">
				<div class="six columns">
					<label for="companyNameInput">Company Name</label> <input
						class="u-full-width" type="text" placeholder="Company Name"
						id="companyNameInput" name="companyName"
			...
			<div class="row">
				<div class="six columns">
					<label for="cityNameInput">City Name</label> <input
						class="u-full-width" type="text" placeholder="City Name"
						id="cityNameInput" name="city" value="${company.city}">
				</div>
				<div class="six columns">
					<label for="sizeInput">Size</label> <select class="u-full-width"
						id="sizeInput">
						<option value="" disabled="disabled" selected="selected">Select
							the Company Size (No. of employees)</option>
			...
			<div class="row">
				...
				<div class="six columns">
					<label for="countryInput">Industry</label> <select
						class="u-full-width" id="industryInput" name="industryId">
			...
			<textarea class="u-full-width" placeholder="About Us" id="about"
				name="about" value="${company.about}">${company.about}</textarea>
			<div class="row">
