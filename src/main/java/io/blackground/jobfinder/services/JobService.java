...
public class JobService {
	...
	public List<Job> findJobsByCompanyCityAndTitleContainingIgnoreCase(String city, String title) {
		return jobRepository.findJobsByCompanyCityAndTitleContainingIgnoreCase(city,title);
	}
